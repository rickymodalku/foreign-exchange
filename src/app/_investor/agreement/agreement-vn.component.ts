...
@Component({
    selector: 'agreement-vn',
    templateUrl: './agreement-vn.html'
})
export class AgreementVNComponent implements OnInit {
    bankForm: FormGroup;
    ...
    constructor(
        ...
        this.sourceOfWealthForm = this._formBuilder.group({
            ...
            employmentEmployer: new FormControl(null, []),
    ...
    ngOnInit() {
        ...
        this._translateService
            ...
            masterData => {
                ...
                this.masterData.otherWealthAmounts = this._baseParameterService.getOtherWealthAmountlist(CONFIGURATION.country_code);
            ...
            if (anySelected) {
                ...
                for (let key in this.formModel.sourceOfWealth.toggleDisplay) {
                    if (this.formModel.sourceOfWealth.toggleDisplay[key]) {
                        switch (key) {
                            case 'business':
                                this.formModel.sourceOfWealth.valid.business = this.checkSourceOfWealthCompletion('businessName') && this.checkSourceOfWealthCompletion('businessAnnualRevenue') && this.checkSourceOfWealthCompletion('businessAnnualProfit') && this.checkSourceOfWealthCompletion('businessCountryOfOperations');
                                break;
                            case 'employment':
                                this.formModel.sourceOfWealth.valid.employment = this.checkSourceOfWealthCompletion('employmentEmployer') && this.checkSourceOfWealthCompletion('employmentTitle') && this.checkSourceOfWealthCompletion('employmentPeriod') && this.checkSourceOfWealthCompletion('employmentAnnualIncome') && this.checkSourceOfWealthCompletion('employmentCountryOfOperations');
                                break;
                            case 'past':
                                this.formModel.sourceOfWealth.valid.past = this.checkSourceOfWealthCompletion('employmentEmployer') && this.checkSourceOfWealthCompletion('employmentTitle') && this.checkSourceOfWealthCompletion('employmentPeriod') && this.checkSourceOfWealthCompletion('employmentAnnualIncome') && this.checkSourceOfWealthCompletion('employmentCompanyNameFull') && this.checkSourceOfWealthCompletion('employmentCountryOfOperations');
                                break;
                        }
                    }
                }
                  ...
                  for (const template of this.subscriptionAgreementTemplates) {
                    switch (template.label) {
                      ...
                      case 'Employment Employer':
                        template.valueString = this.sourceOfWealthForm.get('employmentEmployer').value;
                        break;
                      ...
                      case 'From Business':
                        ...
                        break;
                      case 'Business Name':
                        template.valueString = this.sourceOfWealthForm.get('businessName').value;
                        break;
