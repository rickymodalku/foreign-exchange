...
@Component({
    selector: 'account-activation-sg',
    templateUrl: './account-activation-sg.html'
})
export class AccountActivationSGComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        if (this.currentStep === this.activationStepCode['null'] ||
            ...
            this.currentStep === this.activationStepCode['first_deposit'] ||
